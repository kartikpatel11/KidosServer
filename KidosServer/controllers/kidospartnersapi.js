...
exports.getactivitysummarybyuserid=(function(req,res){
	...
	activities.find({ userid: req.params.userid }).select('activityId name area published contactdetails activitydetails locationdetails imagesdetails type.catImg').populate('type.catImg','catImg').exec(function (err, docs) {
		res.json(200,docs);
	});
});
